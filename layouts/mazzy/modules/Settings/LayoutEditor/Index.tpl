                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li class="blockVisibility" data-visible="{if !$BLOCK_MODEL->isHidden()}1{else}0{/if}" data-block-id="{$BLOCK_MODEL->get('id')}">
                                                            <a href="javascript:void(0)">
                                                                <i class="fa fa-check {if $BLOCK_MODEL->isHidden()} hide {/if}"></i>&nbsp;
...
{/if}
{if $FIELD_MODEL->isCustomField() eq 'true'}
    <a href="javascript:void(0)" class="dropdown-toggle deleteCustomField" data-field-id="{$FIELD_MODEL->get('id')}">
        <i class="fa fa-trash alignMiddle" title="{vtranslate('LBL_DELETE', $QUALIFIED_MODULE)}"></i>
    </a>
{/if}
</span>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li class="blockVisibility" data-visible="1" data-block-id="">
                            <a href="javascript:void(0)">
                                <i class="fa fa-check"></i>&nbsp;{vtranslate('LBL_ALWAYS_SHOW', $QUALIFIED_MODULE)}
                            </a>
                        </li>
                        <li class="inActiveFields">
                            <a href="javascript:void(0)">{vtranslate('LBL_INACTIVE_FIELDS', $QUALIFIED_MODULE)}</a>
        ...
        <div class="row-fluid padding1per">
            ...
            <div class="span11 marginLeftZero" style="word-wrap: break-word;">
                ...
                <span class="btn-group pull-right actions">
                    ...
                    {/if}
                    <a href="javascript:void(0)" class="deleteCustomField" data-field-id=""><i class="fa fa-trash alignMiddle" title="{vtranslate('LBL_DELETE', $QUALIFIED_MODULE)}"></i></a>
                </span>
            </div>
        </div>
    </div>
