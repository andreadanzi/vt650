...
class Project_ProjectsByStatus_Dashboard extends Vtiger_IndexAjax_View {
 
    function getSearchParams($value,$assignedto = '',$dates) {
        $listSearchParams = array();
        $conditions = array(array('projectstatus','e',$value));
	...
	public function process(Vtiger_Request $request) {
		...
		$data = $moduleModel->getProjectsByStatus($request->get('owner'), $dates);
		...
		if(!empty($content)) {
			...
			$viewer->view('dashboards/ProjectsByStatus.tpl', $moduleName);
		}
	}
}
